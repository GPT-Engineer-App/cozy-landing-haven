  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F47C7C] text-black">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="bg-[#FCFBF4] py-16">
        ...
        <section className="py-20 bg-black">
          <div className="container mx-auto px-4">
            ...
            <div className="bg-[#FCFBF4] p-8 rounded-none shadow-lg border border-gray-300 max-w-4xl mx-auto">
        ...
        <section className="py-20 bg-[#FCFBF4]">
          <div className="container mx-auto px-4">
            ...
            <div className="bg-black p-8 rounded-none shadow-lg border border-gray-300 max-w-4xl mx-auto">
        ...
        {/* Contact Us Section */}
        <section className="py-12 bg-black text-[#FCFBF4]">
          <div className="container mx-auto px-4 text-center">
